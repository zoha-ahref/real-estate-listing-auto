...
listing = soup.find_all(name='a', class_="list-card-link")

listing_links = []
for l in listing:
    link = l['href']
    if zillow_link not in link:
        listing_links.append(zillow_link + link)
    else:
...
listing_price = soup.find_all(name='div', class_='list-card-price')
all_listing_prices = []
